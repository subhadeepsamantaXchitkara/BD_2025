...
window.addEventListener('load', () => {
    Swal.fire({
        title: 'Please let me make something special for you!',
        icon: 'warning',
...
const animationTimeline = () => {
    ...
    // SECTION .four (increased visible duration)
    .from(".four", 0.7, { scale: 0.2, opacity: 0 })
    .from(".fake-btn", 0.3, { scale: 0.2, opacity: 0 })
    .staggerTo(".hbd-chatbox span", 1.5, { visibility: "visible" }, 0.05)
    // wait longer before fading out the "Send" part
    .to(".fake-btn", 0.1, { backgroundColor: "rgb(127, 206, 248)" }, "+=6") // increased delay
    .to(".four", 0.5, { scale: 0.2, opacity: 0, y: -150 }, "+=3") // stays on screen longer
...
.to(".celebrate-btn", 0.8, { scale: 1, opacity: 1, ease: Back.easeOut.config(1.7) }, "-=0.5")
